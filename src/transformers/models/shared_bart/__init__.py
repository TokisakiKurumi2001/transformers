...
_import_structure = {
    "configuration_bart": ["BART_PRETRAINED_CONFIG_ARCHIVE_MAP", "BartSharedConfig", "BartSharedOnnxConfig"],
...
if TYPE_CHECKING:
    from .configuration_bart import BART_PRETRAINED_CONFIG_ARCHIVE_MAP, BartSharedConfig, BartSharedOnnxConfig
